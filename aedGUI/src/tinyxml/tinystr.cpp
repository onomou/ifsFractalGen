...
void
TiXmlString::operator =(const char *content)
{
    unsigned newlen;
    char *newstring;
...
void
TiXmlString::append(const char *str, int len)
{
    char *new_string;
...
// append a const char * to an existing TiXmlString
void
TiXmlString::append(const char *suffix)
{
    char *new_string;
...
unsigned
TiXmlString::length() const const
{
    if(allocated)
...
unsigned
TiXmlString::find(char tofind, unsigned offset) const const
{
    char *lookup;
...
bool
TiXmlString::operator ==(const TiXmlString & compare) const const
{
