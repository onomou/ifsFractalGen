...
class TiXmlAttribute:public TiXmlBase
{
  ...
  public:
    ...
    TiXmlAttribute(const char *_name, const char *_value):name(_name),
        value(_value), prev(0), next(0)
    {
    }
...
class TiXmlDeclaration:public TiXmlNode
{
  public:
    ...
    TiXmlDeclaration(const std::string & _version,
                     ...
                     const std::string & _standalone):TiXmlNode(TiXmlNode::
                                                                DECLARATION)
    {
        version = _version;
        encoding = _encoding;
...
#ifdef TIXML_USE_STL
    /// Constructor.
      TiXmlDocument(const std::string & documentName):TiXmlNode(TiXmlNode::
                                                                DOCUMENT)
    {
        value = documentName;
        error = false;
