...
void
TiXmlBase::PutString(const TIXML_STRING & str, TIXML_OSTREAM * stream)
{
    TIXML_STRING buffer;
...
void
TiXmlBase::PutString(const TIXML_STRING & str, TIXML_STRING * outString)
{
    int i = 0;
...
TiXmlNode *
TiXmlNode::IterateChildren(const char *val, TiXmlNode * previous) const
{
    if(!previous)
    {
...
TiXmlNode *
TiXmlNode::PreviousSibling(const char *value) const
{
    TiXmlNode *node;
...
TiXmlElement *
TiXmlNode::FirstChildElement(const char *value) const
{
    TiXmlNode *node;
...
TiXmlElement *
TiXmlNode::NextSiblingElement(const char *value) const
{
    TiXmlNode *node;
...
void
TiXmlElement::SetAttribute(const char *name, const char *value)
{
    TiXmlAttribute *node = attributeSet.Find(name);
...
void
TiXmlElement::StreamOut(TIXML_OSTREAM * stream) const
{
    (*stream) << "<" << value;
...
void
TiXmlDocument::StreamOut(TIXML_OSTREAM * out) const
{
    TiXmlNode *node;
...
void
TiXmlAttribute::StreamOut(TIXML_OSTREAM * stream) const
{
    if(value.find('\"') != TIXML_STRING::npos)
    {
...
void
TiXmlComment::StreamOut(TIXML_OSTREAM * stream) const
{
    (*stream) << "<!--";
    PutString(value, stream);
    (*stream) << "-->";
...
void
TiXmlText::StreamOut(TIXML_OSTREAM * stream) const
{
    PutString(value, stream);
}
...
TiXmlDeclaration::TiXmlDeclaration(const char *_version, const char *_encoding, const char *_standalone):TiXmlNode(TiXmlNode::
          DECLARATION)
{
    version = _version;
    encoding = _encoding;
...
void
TiXmlDeclaration::StreamOut(TIXML_OSTREAM * stream) const
{
    (*stream) << "<?xml ";
...
void
TiXmlUnknown::StreamOut(TIXML_OSTREAM * stream) const
{
